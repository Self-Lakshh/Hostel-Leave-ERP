...
const mockAssistantWardens: AssistantWarden[] = [
  { id: "1", name: "Rahul Mehta", email: "rahul.mehta@spsu.edu", phone: "+91 98765 10001", hostel: "Block A" },
  { id: "2", name: "Kavita Patel", email: "kavita.patel@spsu.edu", phone: "+91 98765 10002", hostel: "Block B" },
  { id: "3", name: "Suresh Kumar", email: "suresh.kumar@spsu.edu", phone: "+91 98765 10003", hostel: "Block C" },
  { id: "4", name: "Anjali Singh", email: "anjali.singh@spsu.edu", phone: "+91 98765 10004", hostel: "Block A" },
];
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {mockAssistantWardens.map((warden) => (
